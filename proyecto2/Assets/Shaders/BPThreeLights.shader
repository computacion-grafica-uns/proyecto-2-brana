        ...
        SubShader{
            ...
            Pass {
                ...
                fixed4 frag(v2f i) : SV_Target {
                    ...
                    // return half4(ambient + pointLightContribution + computePointLight(float4(-0.537, 0, -0.694999993, 1.0), _PointLightColor, i.worldPosition, normal, viewDirection) + spotLightContribution + directionalLightContribution, 1);
